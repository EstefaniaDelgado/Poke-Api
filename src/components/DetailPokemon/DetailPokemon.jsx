    ...
    return(
       ...
       <span className={styles.statNumber}>{pokemonDetail.attack}</span>   
         ...
         <div className={styles.stat}>
          ...
          <div className={styles.stat}>
          <label className={styles.stat_bar_label} for="range">Speed: 
     ...
     <Loading/>
       ...
       {pokemonDetail.createdInDb ? <button className={styles.btn_delete} onClick={(e)=>deleteHandler(e)}>Delete Pokemon</button> : null}
        
      
       <Link to={"/home"} ><button className={styles.btn_back}>Back to Homepage</button></Link>  
